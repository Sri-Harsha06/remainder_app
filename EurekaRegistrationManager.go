...
func (erm EurekaRegistrationManager) RegisterWithSerivceRegistry(eurekaConfigs RegistrationVariables) {
	...
	helper.MakePostCall(eurekaConfigs.ServiceRegistryURL()+"go_micro_1", body, nil)
	...
	helper.MakePostCall(eurekaConfigs.ServiceRegistryURL()+"go_micro_1", bodyUP, nil)
}
...
func (erm EurekaRegistrationManager) SendHeartBeat(eurekaConfigs RegistrationVariables) {
	...
	job := func() {
		...
		helper.MakePutCall(eurekaConfigs.ServiceRegistryURL()+"go_micro_1/"+hostname, nil, nil)
	}
...
func (erm EurekaRegistrationManager) getBodyForEureka(status string) *AppRegistrationBody {
	...
	instance := InstanceDetails{hostname, "go_micro_1", "go_micro_1", "go_micro_1",
